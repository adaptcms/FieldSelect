...
class FieldSelectServiceProvider extends ServiceProvider
{
  /**
  ...
  {
    $this->mergeConfigFrom(__DIR__.'/../config/fieldselect.php', 'fieldselect');

    // Register the service the package provides.
    $this->app->singleton('FieldSelect', function ($app) {
  ...
  protected function bootForConsole()
  {
    ...
    $this->publishes([
        __DIR__.'/../config/fieldselect.php' => config_path('fieldselect.php'),
    ], 'fieldselect.config');
    ...
    foreach (glob(__DIR__ . '/Console/Commands/*.php') as $row) {
      // init class path
      $classPath = '\\Adaptcms\\FieldSelect\\Console\\Commands\\';
